...
Revision ID: 408b0551f09b
Revises: 
Create Date: 2025-04-30 02:31:13.048932
...
def upgrade():
    ...
    sa.Column('variant_type', sa.Enum('ORIGINAL', 'THUMBNAIL', 'MEDIUM', 'LARGE', 'SMALL', name='mediavarianttype'), nullable=True),
    sa.Column('storage_key', sa.String(length=255), nullable=True),
    sa.Column('width', sa.Integer(), nullable=True),
    sa.Column('height', sa.Integer(), nullable=True),
    sa.Column('file_size', sa.Integer(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['parent_id'], ['product_comments.id'], ),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
